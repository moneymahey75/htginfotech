                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                  <div className="max-w-3xl">
                    ...
                    <span className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20 text-white">
                      ...
                      <span className="text-sm font-medium">{sliders[currentSlide].ts_subtitle}</span>
                    </span>
                        </div>
                    )}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      {sliders[currentSlide]?.ts_button_text && (
                          <Link
                              to={sliders[currentSlide].ts_button_link || '#'}
                          ...
                          >
                            <span>{sliders[currentSlide].ts_button_text}</span>
                            <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                          </Link>
                      )}

                      {sliders[currentSlide]?.ts_button2_text && (
                          <Link
                              to={sliders[currentSlide].ts_button2_link || '#'}
                          ...
                          >
                            <span>{sliders[currentSlide].ts_button2_text}</span>
                            <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                          </Link>
                      )}

                      {!sliders[currentSlide]?.ts_button_text && !sliders[currentSlide]?.ts_button2_text && (
                          <button
                              className="group border-2 border-white/30 text-white px-8 py-4 rounded-2xl font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300 flex items-center justify-center space-x-3 backdrop-blur-sm"
                              onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  image: 'https://images.pexels.com/photos/4144222/pexels-photo-4144222.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop'
                },
                {
                  icon: TrendingUp,
                ...
                },
                {
                  ...
                  <div key={index} className="group relative flex flex-col">
                    <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-gray-200 transform hover:-translate-y-4 overflow-hidden flex flex-col h-full">
                      {/* Feature Image */}
                      ...
                      <div className="p-8 relative flex flex-col flex-grow">
                        <div className={`${feature.bgColor} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 -mt-12 relative z-10 shadow-lg flex-shrink-0`}>
                          <feature.icon className={`h-8 w-8 ${feature.iconColor}`} />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">{feature.title}</h3>
                        <p className="text-gray-600 text-center leading-relaxed flex-grow">{feature.description}</p>
                      </div>
                    </div>
                  </div>
              ))}
        ...
        <section className="py-20 bg-gradient-to-r from-slate-900 via-emerald-900 to-teal-900 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <p className="text-xl mb-12 text-gray-200 max-w-3xl mx-auto">
              Thousands of professionals and job providers have transformed their lives with our platform. Your success story starts here.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {[
                { name: "Sarah Johnson", achievement: "Software Tester", period: "6 months", image: "https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop" },
                { name: "Michael Chen", achievement: "Quality Engineer", period: "8 months", image: "https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop" },
                { name: "Emma Davis", achievement: "English Teacher", period: "1 year", image: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop" }
              ].map((story, index) => (
