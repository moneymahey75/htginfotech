            ...
            <div
                ...
                <div className="p-4 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        <div
                            className="bg-gradient-to-r from-red-500 to-orange-500 w-10 h-10 rounded-xl flex items-center justify-center">
                                            ...
                                            <div className="grid grid-cols-3 gap-4">
                                                {['read', 'write', 'delete'].map((action) => (
                                                    <label key={action} className="flex items-center">
                                                        ...
                                                        />
                                                        <span
                                                            className="ml-2 text-sm text-gray-700 capitalize">{action}</span>
                                                    </label>
                                                ))}
                                            </div>
                                        </div>
                    ...
                    <span className={`flex items-center ${perms.read ? 'text-green-600' : 'text-gray-400'}`}>
                      {perms.read ? <Check className="h-4 w-4 mr-1"/> : <X className="h-4 w-4 mr-1"/>}
                        Read
                                        ...
                                        <span
                                            className={`flex items-center ${perms.write ? 'text-green-600' : 'text-gray-400'}`}>
                      {perms.write ? <Check className="h-4 w-4 mr-1"/> : <X className="h-4 w-4 mr-1"/>}
                                            Write
                    </span>
                                        <span
                                            className={`flex items-center ${perms.delete ? 'text-green-600' : 'text-gray-400'}`}>
