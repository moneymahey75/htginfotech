...
const JobSeekers: React.FC = () => {
    ...
    const features = [
        ...
        "Market-Trending Courses",
        "High-Income Career Courses",
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600">Watch this video to learn how our platform can help you
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Join thousands of successful job seekers who found their perfect career match through our
                            platform.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {benefits.map((benefit, index) => (
                            <div key={index}
                                 className="icn-align-cnt bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow">
                                <div
                                    className="bg-blue-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-600 mb-8">
                                Our comprehensive platform provides all the tools and resources you need to find and
