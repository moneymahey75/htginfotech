    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
                            ...
                            <>
                                {payments.map((payment) => (
                                    <tr key={payment.tp_id} className="border-b border-gray-100 hover:bg-gray-50">
                                        ...
                                        <td className="py-3 px-4">
                        <span
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(payment.tp_payment_status)}`}>
                ...
                {totalCount > 0 && (
                    <div
                        className="px-4 py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                {paymentSplits.map((split, index) => (
                                    <div key={index}
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span
                                                className={`text-xs px-2 py-1 rounded-full ${getStatusColor(split.tpst_status)}`}>
                        {split.tpst_status}
                      </span>
                                        </div>
                                    </div>
