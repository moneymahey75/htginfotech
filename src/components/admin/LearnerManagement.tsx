                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <div className="flex-shrink-0 h-10 w-10">
                                                    <div
                                                        className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center">
                                ...
                                {profile?.tup_first_name?.charAt(0) || 'L'}
                                                ...
                                                <div className="ml-4">
                                                    <div className="text-sm font-medium text-gray-900">
                                                        <a onClick={() => handleViewLearner(learner)}
                        ...
                        <div className="space-y-6">
                            ...
                            {interest}
                                    ...
                                    {editMode && (
                                        <>
                                            <div>
                                                <label className="text-sm font-medium text-gray-500">Account
                                                    Status</label>
                                                <select
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    <label className="text-sm font-medium text-gray-500">Email
                                                        Verification</label>
                                                    <select
                                                        value={editData.email_verified ? 'verified' : 'unverified'}
                                                        onChange={(e) => setEditData(prev => ({
                                                            ...prev,
                                                            email_verified: e.target.value === 'verified'
                                                        }))}
                                                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                    >
                                                        <option value="verified">Verified</option>
                                                ...
                                                <div>
                                                    <label className="text-sm font-medium text-gray-500">Mobile
                                                        Verification</label>
                                                    <select
                                                        value={editData.mobile_verified ? 'verified' : 'unverified'}
                                                        onChange={(e) => setEditData(prev => ({
                                                            ...prev,
                                                            mobile_verified: e.target.value === 'verified'
                                                        }))}
                                                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                    >
                                                        <option value="verified">Verified</option>
                            ...
                            <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div className="flex-1">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 mt-4">
                                                    <div>
                                                        <span
                                                            className="text-xs font-medium text-gray-500">Difficulty</span>
                                                    ...
                                                    <div>
                                                        <span
                                                            className="text-xs font-medium text-gray-500">Progress</span>
                                                        <div className="flex items-center space-x-2">
                                ...
                                {Math.round(enrollment.tce_progress_percentage)}%
                                                ...
                                                {enrollment.tce_completed_at && (
                                                    <div className="mt-2">
                                                        <span
                                                            className="text-xs font-medium text-gray-500">Completed:</span>
