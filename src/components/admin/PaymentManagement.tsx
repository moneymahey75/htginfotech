                    ...
                    {filteredPayments.map((payment) => (
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex items-center">
                                    <div className="flex-shrink-0 h-10 w-10">
                                        <div
                                            className="h-10 w-10 rounded-full bg-gradient-to-r from-green-500 to-blue-600 flex items-center justify-center">
                        <span className="text-white font-medium text-sm">
                          {payment.tbl_users?.tbl_user_profiles?.tup_first_name?.charAt(0) || 'U'}
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                  <span
                      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(payment.tp_payment_status)}`}>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <span
                                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(payment.tp_payment_status)}`}>
                    {getStatusIcon(payment.tp_payment_status)}
                                        <span className="ml-1 capitalize">{payment.tp_payment_status}</span>
                  </span>
                                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        {payment.tp_gateway_response && (
                            <div className="bg-gray-50 p-6 rounded-lg">
                                ...
                                <pre
                                    className="text-xs text-gray-600 bg-white p-3 rounded border overflow-auto max-h-40">
