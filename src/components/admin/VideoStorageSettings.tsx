    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Choose your video storage provider and configure credentials.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="font-semibold text-lg mb-1">Bunny Stream</div>
            <div className="text-sm text-gray-600 mb-2">$3-5/month for 100GB</div>
            <div className="text-xs text-gray-500">
              Professional streaming with transcoding
            </div>
          </button>
        </div>
      </div>
        ...
        <div className="bg-orange-50 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-600 mt-1">
                Required: R2 bucket public domain URL for video playback
              </p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="bg-orange-100 border border-orange-200 rounded-lg p-4 mt-4">
              ...
              <p className="text-xs text-orange-800">
                Before using Cloudflare R2, deploy the Cloudflare Worker.
                See <code className="bg-orange-200 px-1 py-0.5 rounded">WORKER_DEPLOYMENT.md</code> for instructions.
              </p>
            </div>
          </div>
        </div>
      ...
      {settings.tvss_active_provider === 'bunny' && (
        <div className="bg-purple-50 rounded-lg p-6">
          <h3 className="font-semibold text-purple-900 mb-4">Bunny Stream Configuration</h3>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        <h3 className="font-semibold text-gray-900 mb-2">Storage Provider Comparison</h3>
        <div className="text-sm text-gray-600 space-y-3">
          <div>
            <p className="font-semibold text-orange-700">Cloudflare R2</p>
            <ul className="list-disc list-inside ml-4 space-y-1 mt-1">
              <li>Free tier: 10GB storage</li>
              <li>No egress fees (unlimited bandwidth)</li>
              <li>Global CDN distribution</li>
              <li>S3-compatible API</li>
              <li>Requires Cloudflare Worker deployment</li>
            </ul>
          </div>
          <div>
            <p className="font-semibold text-purple-700">Bunny Stream</p>
            <ul className="list-disc list-inside ml-4 space-y-1 mt-1">
              <li>Automatic video transcoding to multiple qualities</li>
              <li>HLS adaptive streaming</li>
              <li>Professional video player included</li>
              <li>Automatic thumbnail generation</li>
              <li>Token-based security</li>
              <li>Pricing: ~$3-5/month for 100GB</li>
            </ul>
          </div>
          <p className="text-xs text-gray-500 mt-2">
            Choose Cloudflare R2 for cost-effective storage with free egress. Choose Bunny Stream for professional video streaming with transcoding.
          </p>
        </div>
      </div>
    </div>
